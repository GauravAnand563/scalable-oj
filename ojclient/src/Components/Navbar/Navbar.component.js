...
function NavbarComponent(){
    ...
    return <div className="navBar">
                <div className = 'logoAndText'>
                    <img className = 'image'src = 'https://img.icons8.com/external-flatarticons-blue-flatarticons/65/external-judge-auction-flatarticons-blue-flatarticons-1.png'/> 
                    <a className = 'logoText' href="/"><h1><b>Redesigned OJ</b></h1></a> 
                </div>
