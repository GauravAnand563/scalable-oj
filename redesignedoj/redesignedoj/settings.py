"""
Django settings for redesignedoj project.
...
SECRET_KEY = 'django-insecure--(n_tf(gzftm4htt6e2t-))1ew@09x40a58f=&68(d=6q_y7&6'
...
WSGI_APPLICATION = 'redesignedoj.wsgi.application'
